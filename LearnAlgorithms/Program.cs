...
namespace LearnAlgorithms
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //int[] array = new int[] { 8, 5, 9, 12, 59, 1, 75, 66, 91 };
            //List<int> sortingArray = SortingAlgorithms.SelectionSort(array);
            //sortingArray.ForEach(x => Console.WriteLine(x));
            //#endregion
